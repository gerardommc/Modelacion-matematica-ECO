...
\caption{La parábola de los seis hombres ciegos inspeccionando un elefante.}\label{fig:unnamed-chunk-14}
\end{figure}
...
\caption{ Diagrama de mi estrategia para desarrollar modelos.}\label{fig:unnamed-chunk-15}
\end{figure}
...
\caption{Relación entre el entendimiento y calidad de los datos, y los potenciales usos de los modelos en las diferentes disciplinas científicas [@haefner1998modeling].}\label{fig:unnamed-chunk-16}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-19}Cinco realizaciones para la conversión de dos pulgadas a centímetros con el modelo determinista y estocástico.}
\centering
\begin{tabular}[t]{c|c}
\hline
...
\caption{Ejemplo del plano cartesiado mostrando en rojo la correspondencia de valores para $y(x) = x$, donde los puntos corresponden a los pares de valores $(x = -1, y = -1), (-0.5, -0.5), (0, 0), (0.5, 0.5), (1, 1)$.}\label{fig:unnamed-chunk-20}
\end{figure}
...
{\centering \includegraphics{Mod-mat-ECO_files/figure-latex/unnamed-chunk-21-1} 

}

\caption{Gráficas de las funciones $y(x) = 0.5 x$ (en rojo) y $y(x) = 0.5 + 0.5 x$ (azul). Las líneas punteadas en colores indican el efecto de las constantes $a$ y $b$, mientas que Δ$x$ denota el cambio de una unidad de $x$.}\label{fig:unnamed-chunk-21}
\end{figure}
