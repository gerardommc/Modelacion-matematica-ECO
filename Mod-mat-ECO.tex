...
\caption{La parábola de los seis hombres ciegos inspeccionando un elefante.}\label{fig:unnamed-chunk-15}
\end{figure}
...
\caption{ Diagrama de mi estrategia para desarrollar modelos.}\label{fig:unnamed-chunk-16}
\end{figure}
...
{\centering \includegraphics{Mod-mat-ECO_files/figure-latex/unnamed-chunk-22-1} 
...
\hypertarget{sucesiones-por-recurrencia}{%
\subsection{Sucesiones por recurrencia}\label{sucesiones-por-recurrencia}}
...
\hypertarget{otras-sucesiones}{%
\subsection{Otras sucesiones}\label{otras-sucesiones}}

A diferencia de la sucesión de la ecuación \eqref{eq:a2n}, la sucesión de Fibonacci, utiliza los números naturales para iniciar la secuencia, y posteriormente se usan para indizar los elementos de \(a\) que continuarán con el desarrollo de la secuencia.
